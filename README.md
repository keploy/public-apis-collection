...
|-----|-------------|------|------------|
| Bored API | Generates random fun activities | No | Yes | [Link](https://www.boredapi.com/api/activity) |
| [Cat Facts](https://catfact.ninja/) | <details><summary>Random cat facts API for fun or educational use</summary>Add a fun twist to your apps with quirky cat facts. Useful for beginner projects, animal trivia, or small games.</details> | No Auth | Easy |
| [Bored API](https://www.boredapi.com/api/activity) | <details><summary>Suggests fun and random activities when you're bored</summary>Great for creative apps, productivity tools, or just fun widgets. Responses include activity type, participant count, and accessibility score.</details> | No Auth | Easy |
| [Numbers API](https://numbersapi.com) | <details><summary>Get trivia and facts about numbers, math, or historical dates</summary>Useful for educational apps, math games, or daily fact generators. Supports different categories like trivia, math, and year.</details> | No Auth | Easy |
| [SpaceX API](https://api.spacexdata.com/v4) | <details><summary>Access SpaceX data about launches, rockets, missions, and more</summary>Perfect for building space-themed dashboards or learning REST APIs. Includes historical and upcoming launch data.</details> | No Auth | Medium |
| [Kanye Rest](https://api.kanye.rest) | <details><summary>Returns random Kanye West quotes via simple API call</summary>Fun and meme-worthy API that returns a new Kanye quote on every call. Great for beginner front-end projects or Slack bots.</details> | No Auth | Easy |
