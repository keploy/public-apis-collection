...
|-----|-------------|------|------------|
| [Google Gemini API](https://ai.google.dev/gemini-api/docs) | <details><summary>Access Google's Gemini models for building AI-powered applications</summary>Use Google's Gemini models (Pro, Flash, etc.) to build chatbots, summarizers, code generators, and multimodal apps with text and image input/output. Ideal for AI-powered content generation, productivity tools, and assistants.</details> | API Key | Medium |
